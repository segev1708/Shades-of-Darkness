...
while True:
    ...
    if ended == False:
        ...
        if playerY < (playSize[1]+playSize[3])-49:
            if keys[K_s] or keys[K_DOWN]:
                ...
                Player.move([0,1])
    # time 
    ticks, timeNow = pygame.time.get_ticks() - realTicks, pygame.time.get_ticks() - realTicks
    ...
    if timeNow >= 10:
        ...
        if timeNow >=14 and timeNow < 24:
            ...
            if wave4 == False:
                ...
                circle1Pos = [400+randint(-20,20),-120+randint(-20,20)] 
                circle5Pos = [600+randint(-20,20),-180+randint(-20,20)] 
                circle2Pos = [450+randint(-30,30),-150+randint(-20,20)] 
                circle3Pos = [500+randint(-40,40),-140+randint(-20,20)] 
                circle4Pos = [550+randint(-30,20),-150+randint(-20,20)] 
            if playSize[2] < 300:
                playSize[2]+= 5
            ...
            if timeNow >= 27:
                circle1 = pygame.draw.circle(screen,[255,255,255],circle1Pos,8.5)   

                circle2= pygame.draw.circle(screen,[255,255,255],circle2Pos,8.5)    

                circle3 = pygame.draw.circle(screen,[255,255,255],circle3Pos,8.5)

                circle4 = pygame.draw.circle(screen,[255,255,255],circle4Pos,8.5)

                circle5 = pygame.draw.circle(screen,[255,255,255],circle5Pos,8.5)
                if ticks>= 29.35*1000:
                    circle1Pos[1] -= 7 + randint(-1,1)
                    circle2Pos[1] -= 7 + randint(-1,1)
                    circle3Pos[1] -= 7 + randint(-1,1)
                    circle4Pos[1] -= 7 + randint(-1,1)
                    circle5Pos[1] -= 7 + randint(-1,1)             
                else:
                    circle1Pos[1] += 7 + randint(-1,1)
                    circle2Pos[1] += 7 + randint(-1,1)
                    circle3Pos[1] += 7 + randint(-1,1)
                ...
                for circle in circles:
                    if circle.colliderect(playerRect):
                        ended = end(ended)
    ...
    if ended:
        ...
        Player.blit()
        if won:
            pressHeart = Text("YOU WON!",40,(430,140),r"assets\other\Determination.ttf",(255,255,255))
            pressHeart2 = Text("PRESS YOUR HEART TO PLAY AGAIN",40,(200,180),r"assets\other\Determination.ttf",(255,255,255))
            pressHeart2.blit()
        else:
            pressHeart = Text("PRESS YOUR HEART TO TRY AGAIN",40,(190,150),r"assets\other\Determination.ttf",(255,255,255))
        pressHeart.blit()
